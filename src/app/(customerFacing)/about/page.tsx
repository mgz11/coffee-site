...
export default function AboutPage() {
	return (
		<div className="container mx-auto px-4 py-8 bg-amber-50 min-h-screen">
			...
			<section className="mb-12">
				<h2 className="text-2xl font-semibold mb-4 text-brown-600">Our Team</h2>
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
					{[
						{
							name: "Emma Johnson",
				...
				<Card className="bg-white">
					<CardContent className="p-6">
						<p className="text-lg">
							...
							serving high-quality, ethically sourced coffee and food made with
							love. Our goal is to make every visit a delightful experience that
